...
/*! @brief Formats the given seconds into days, hours, minutes and seconds.
 *
 *  @param tempSeconds The total amount of seconds to be formatted.
 ...
 *  @note Assumes that the RTC module has been initialized.
 */
void RTC_Format_Time(int tempSeconds, uint8_t* const days, uint8_t* const hours, uint8_t* const minutes, uint8_t* const seconds);

/*! @brief Formats the given seconds into hours, minutes and seconds.
 *
 *  @param tempSeconds The total amount of seconds to be formatted.
 *  @param hours The address of a variable to store the real time clock hours.
 *  @param minutes The address of a variable to store the real time clock minutes.
 ...
 *  @note Assumes that the RTC module has been initialized.
 */
void RTC_Format_Hours(int tempSeconds, uint8_t* const hours, uint8_t* const minutes, uint8_t* const seconds);
